              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 39),
                    Text("Choose Size",style: GoogleFonts.cormorantGaramond(
                      fontSize: 20,
                      color: Color(0xFF31405D),
                    ),),
                    SizedBox(height: 31),
                    SizeWidget(),
                    SizedBox(height: 39),
                    Text("Choose Color",style: GoogleFonts.cormorantGaramond(
                      fontSize: 20,
                      color: Color(0xFF31405D),
                    ),),
                    SizedBox(height: 28),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            width: 24,
                            height: 24,
                            decoration: BoxDecoration(color: colorsList[index],shape: BoxShape.circle),
                          );
                        },
                      ),
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        CustomButton.black("Buy now", boxShadow:  [
                          BoxShadow(
                            offset: Offset(9, 9),
                            blurRadius: 16,
                        ...
                        Image(image: AssetImage("assets/Group 167.png"),width: 42,height: 36,color: Colors.purple,),
                      ],
                    ),
                  ],
                ),
